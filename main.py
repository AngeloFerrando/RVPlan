...
# os.system('java -jar /media/angelo/WorkData/lamaconv-snapshot-2016-09-07/rltlconv.jar "LTL=' + ltl_list[0].replace('-', '').replace('_', '') + '" --formula --nbas --min --nfas --dfas --min --moore --pdf > foo.pdf')
