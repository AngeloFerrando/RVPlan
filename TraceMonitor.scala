...
/*
  prop fo_ltl_0 : Forall r . Forall x . Forall y . act_up(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y)) 
*/
...
class Formula_fo_ltl_0(monitor: Monitor) extends Formula(monitor) {
  ...
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      ...
      now(16) = build("robot_at")(V("r1"),V("x1"))
      now(17) = build("robot_at")(V("r"),V("x"))
      now(19) = build("up")(V("x"),V("y"))
      now(21) = build("empty")(V("y"))
      now(25) = build("empty")(V("y1"))
      now(26) = build("empty")(V("y"))
    ...
    // assignments5 (main formula excluding leaf nodes):
      ...
      now(15) = var_x1.seen.and(now(16)).exist(var_x1.quantvar)
      now(14) = var_r1.seen.and(now(15)).exist(var_r1.quantvar)
      now(13) = now(14).not()
      now(12) = now(17).or(now(13).and(pre(12)))
      now(9) = now(10).and(now(12))
      now(18) = now(19).or(pre(18))
      now(8) = now(9).and(now(18))
      now(20) = now(21).or(pre(20))
      now(7) = now(8).and(now(20))
      now(24) = var_y1.seen.and(now(25)).exist(var_y1.quantvar)
      now(23) = now(24).not()
      now(22) = now(26).or(now(23).and(pre(22)))
      now(6) = now(7).and(now(22))
      now(28) = now(29).not()
      now(27) = now(28).or(pre(27))
      now(5) = now(6).and(now(27))
  ...
  val var_r :: var_x :: var_y :: var_r1 :: var_x1 :: var_y1 :: Nil = declareVariables(("r",false), ("x",false), ("y",false), ("r1",true), ("x1",true), ("y1",true))(0)

  varsInRelations = Set()
  val indices: List[Int] = List(27,22,20,18,12,10)

  pre = Array.fill(30)(bddGenerator.False)
  now = Array.fill(30)(bddGenerator.False)

  txt = Array(
    "Forall r . Forall x . Forall y . act_up(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall x . Forall y . act_up(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall y . act_up(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_up(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_up(r,x,y)",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y)) & P (empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (up(x,y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)",
      "!(exists r1 . exists x1 . robot_at(r1,x1))",
      "exists r1 . exists x1 . robot_at(r1,x1)",
      "exists x1 . robot_at(r1,x1)",
      "robot_at(r1,x1)",
      "robot_at(r,x)",
      "P (up(x,y))",
      "up(x,y)",
...
/*
  prop fo_ltl_1 : Forall r . Forall x . Forall y . act_down(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y)) 
*/
...
class Formula_fo_ltl_1(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . act_down(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall x . Forall y . act_down(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall y . act_down(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_down(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_down(r,x,y)",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y)) & P (empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (down(x,y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)",
...
/*
  prop fo_ltl_2 : Forall r . Forall x . Forall y . act_right(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y)) 
*/
...
class Formula_fo_ltl_2(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . act_right(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall x . Forall y . act_right(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall y . act_right(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_right(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_right(r,x,y)",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y)) & P (empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (right(x,y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)",
...
/*
  prop fo_ltl_3 : Forall r . Forall x . Forall y . act_left(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y)) 
*/
...
class Formula_fo_ltl_3(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . act_left(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall x . Forall y . act_left(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "Forall y . act_left(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_left(r,x,y) -> P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "act_left(r,x,y)",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y)) & P (!radiation(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y)) & (!(exists y1 . empty(y1)) S empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y)) & P (empty(y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)) & P (left(x,y))",
      "P (robot_at(r,x)) & (!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "!(exists r1 . exists x1 . robot_at(r1,x1)) S robot_at(r,x)",
...
/*
  prop fo_ltl_4 : Forall r . Forall x . Forall y . Forall t . act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t)) 
*/
...
class Formula_fo_ltl_4(monitor: Monitor) extends Formula(monitor) {
  ...
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      ...
      now(10) = build("robot_at")(V("r"),V("x"))
      now(12) = build("tank_at")(V("t"),V("y"))
      now(14) = build("up")(V("x"),V("y"))
      now(17) = build("inspected")(V("t"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
      ...
      now(8) = now(9).and(now(11))
      now(13) = now(14).or(pre(13))
      now(7) = now(8).and(now(13))
      now(16) = now(17).not()
      now(15) = now(16).or(pre(15))
      now(6) = now(7).and(now(15))
  ...
  varsInRelations = Set()
  val indices: List[Int] = List(15,13,11,9)

  pre = Array.fill(18)(bddGenerator.False)
  now = Array.fill(18)(bddGenerator.False)

  txt = Array(
    "Forall r . Forall x . Forall y . Forall t . act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "Forall x . Forall y . Forall t . act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "Forall y . Forall t . act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "Forall t . act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "act_inspect_up(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "act_inspect_up(r,x,y,t)",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y)) & P (!inspected(t))",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (up(x,y))",
      "P (robot_at(r,x)) & P (tank_at(t,y))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "P (tank_at(t,y))",
      "tank_at(t,y)",
...
/*
  prop fo_ltl_5 : Forall r . Forall x . Forall y . Forall t . act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t)) 
*/
...
class Formula_fo_ltl_5(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . Forall t . act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "Forall x . Forall y . Forall t . act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "Forall y . Forall t . act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "Forall t . act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "act_inspect_down(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "act_inspect_down(r,x,y,t)",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y)) & P (!inspected(t))",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (down(x,y))",
      "P (robot_at(r,x)) & P (tank_at(t,y))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "P (tank_at(t,y))",
...
/*
  prop fo_ltl_6 : Forall r . Forall x . Forall y . Forall t . act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t)) 
*/
...
class Formula_fo_ltl_6(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . Forall t . act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "Forall x . Forall y . Forall t . act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "Forall y . Forall t . act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "Forall t . act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "act_inspect_right(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "act_inspect_right(r,x,y,t)",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y)) & P (!inspected(t))",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (right(x,y))",
      "P (robot_at(r,x)) & P (tank_at(t,y))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "P (tank_at(t,y))",
...
/*
  prop fo_ltl_7 : Forall r . Forall x . Forall y . Forall t . act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t)) 
*/
...
class Formula_fo_ltl_7(monitor: Monitor) extends Formula(monitor) {
  ...
  txt = Array(
    "Forall r . Forall x . Forall y . Forall t . act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "Forall x . Forall y . Forall t . act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "Forall y . Forall t . act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "Forall t . act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "act_inspect_left(r,x,y,t) -> P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "act_inspect_left(r,x,y,t)",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y)) & P (!inspected(t))",
      "P (robot_at(r,x)) & P (tank_at(t,y)) & P (left(x,y))",
      "P (robot_at(r,x)) & P (tank_at(t,y))",
      "P (robot_at(r,x))",
      "robot_at(r,x)",
      "P (tank_at(t,y))",
...
class PropertyMonitor extends Monitor {
  def eventsInSpec: Set[String] = Set("radiation","robot_at","up","act_down","act_inspect_down","act_inspect_right","tank_at","act_right","act_up","right","empty","act_inspect_up","left","inspected","down","act_inspect_left","act_left")
