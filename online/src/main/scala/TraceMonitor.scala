...
/*
  prop ltl_0 : !P !((act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))) & (@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0'')))) 
*/

class Formula_ltl_0(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_right")(C("rover"),C("cell_0_0"),C("cell_1_0"))
      now(10) = build("robot_at")(C("rover"),C("cell_0-0"))
      now(11) = build("right")(C("cell_0-0"),C("cell_1-0"))
      now(12) = build("empty")(C("cell_1-0"))
      now(14) = build("radiation")(C("cell_1-0"))
      now(17) = build("act_right")(C("rover"),C("cell_0_0"),C("cell_1_0"))
      now(21) = build("robot_at")(C("rover"),C("cell_1_0"))
      now(23) = build("robot_at")(C("rover"),C("cell_0_0"))
      now(24) = build("empty")(C("cell_0_0"))
      now(26) = build("empty")(C("cell_1_0"))
    ...
    // assignments5 (main formula excluding leaf nodes):
      ...
      now(8) = now(9).and(now(12))
      now(13) = now(14).not()
      now(7) = now(8).and(now(13))
      now(6) = pre(7)
      now(4) = now(5).not().or(now(6))
      now(16) = pre(17)
      now(22) = now(23).not()
      now(20) = now(21).and(now(22))
      now(19) = now(20).and(now(24))
      now(25) = now(26).not()
      now(18) = now(19).and(now(25))
      now(15) = now(16).not().or(now(18))
      now(3) = now(4).and(now(15))
      now(2) = now(3).not()
  ...
  varsInRelations = Set()
  val indices: List[Int] = List(1,16,6)

  pre = Array.fill(27)(bddGenerator.False)
  now = Array.fill(27)(bddGenerator.False)

  txt = Array(
    "!P !((act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))) & (@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0''))))",
      "P !((act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))) & (@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0''))))",
      "!((act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))) & (@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0''))))",
      "(act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))) & (@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0'')))",
      "act_right(''rover'',''cell_0_0'',''cell_1_0'') -> @ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))",
      "act_right(''rover'',''cell_0_0'',''cell_1_0'')",
      "@ (robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0''))",
      "robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'') & !radiation(''cell_1-0'')",
      "robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'') & empty(''cell_1-0'')",
      "robot_at(''rover'',''cell_0-0'') & right(''cell_0-0'',''cell_1-0'')",
      "robot_at(''rover'',''cell_0-0'')",
      "right(''cell_0-0'',''cell_1-0'')",
      "empty(''cell_1-0'')",
      "!radiation(''cell_1-0'')",
      "radiation(''cell_1-0'')",
      "@ (act_right(''rover'',''cell_0_0'',''cell_1_0'')) -> (robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0''))",
      "@ (act_right(''rover'',''cell_0_0'',''cell_1_0''))",
      "act_right(''rover'',''cell_0_0'',''cell_1_0'')",
      "robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'') & !empty(''cell_1_0'')",
      "robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'') & empty(''cell_0_0'')",
      "robot_at(''rover'',''cell_1_0'') & !robot_at(''rover'',''cell_0_0'')",
      "robot_at(''rover'',''cell_1_0'')",
      "!robot_at(''rover'',''cell_0_0'')",
      "robot_at(''rover'',''cell_0_0'')",
      "empty(''cell_0_0'')",
      "!empty(''cell_1_0'')",
      "empty(''cell_1_0'')"
...
/*
  prop ltl_1 : !P !((act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1'')))) 
*/

class Formula_ltl_1(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_inspect_right")(C("rover"),C("cell_1_0"),C("cell_2_0"),C("tank1"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-0"))
      now(11) = build("tank_at")(C("tank1"),C("cell_2-0"))
      now(12) = build("right")(C("cell_1-0"),C("cell_2-0"))
      now(14) = build("inspected")(C("tank1"))
      now(17) = build("act_inspect_right")(C("rover"),C("cell_1_0"),C("cell_2_0"),C("tank1"))
      now(18) = build("inspected")(C("tank1"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1''))))",
      "P !((act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1''))))",
      "!((act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1''))))",
      "(act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1'')))",
      "act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'') -> @ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))",
      "act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')",
      "@ (robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1''))",
      "robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'') & !inspected(''tank1'')",
      "robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'') & right(''cell_1-0'',''cell_2-0'')",
      "robot_at(''rover'',''cell_1-0'') & tank_at(''tank1'',''cell_2-0'')",
      "robot_at(''rover'',''cell_1-0'')",
      "tank_at(''tank1'',''cell_2-0'')",
      "right(''cell_1-0'',''cell_2-0'')",
      "!inspected(''tank1'')",
      "inspected(''tank1'')",
      "@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')) -> (inspected(''tank1''))",
      "@ (act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1''))",
      "act_inspect_right(''rover'',''cell_1_0'',''cell_2_0'',''tank1'')",
      "inspected(''tank1'')"
  )
...
/*
  prop ltl_2 : !P !((act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1'')))) 
*/

class Formula_ltl_2(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_down")(C("rover"),C("cell_1_0"),C("cell_1_1"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-0"))
      now(11) = build("down")(C("cell_1-0"),C("cell_1-1"))
      now(12) = build("empty")(C("cell_1-1"))
      now(14) = build("radiation")(C("cell_1-1"))
      now(17) = build("act_down")(C("rover"),C("cell_1_0"),C("cell_1_1"))
      now(21) = build("robot_at")(C("rover"),C("cell_1_1"))
      now(23) = build("robot_at")(C("rover"),C("cell_1_0"))
      now(24) = build("empty")(C("cell_1_0"))
      now(26) = build("empty")(C("cell_1_1"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1''))))",
      "P !((act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1''))))",
      "!((act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1''))))",
      "(act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1'')))",
      "act_down(''rover'',''cell_1_0'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))",
      "act_down(''rover'',''cell_1_0'',''cell_1_1'')",
      "@ (robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))",
      "robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1'')",
      "robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'') & empty(''cell_1-1'')",
      "robot_at(''rover'',''cell_1-0'') & down(''cell_1-0'',''cell_1-1'')",
      "robot_at(''rover'',''cell_1-0'')",
      "down(''cell_1-0'',''cell_1-1'')",
      "empty(''cell_1-1'')",
      "!radiation(''cell_1-1'')",
      "radiation(''cell_1-1'')",
      "@ (act_down(''rover'',''cell_1_0'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1''))",
      "@ (act_down(''rover'',''cell_1_0'',''cell_1_1''))",
      "act_down(''rover'',''cell_1_0'',''cell_1_1'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'') & !empty(''cell_1_1'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'') & empty(''cell_1_0'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_1_0'')",
      "robot_at(''rover'',''cell_1_1'')",
      "!robot_at(''rover'',''cell_1_0'')",
      "robot_at(''rover'',''cell_1_0'')",
      "empty(''cell_1_0'')",
      "!empty(''cell_1_1'')",
...
/*
  prop ltl_3 : !P !((act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2'')))) 
*/

class Formula_ltl_3(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_down")(C("rover"),C("cell_1_1"),C("cell_1_2"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-1"))
      now(11) = build("down")(C("cell_1-1"),C("cell_1-2"))
      now(12) = build("empty")(C("cell_1-2"))
      now(14) = build("radiation")(C("cell_1-2"))
      now(17) = build("act_down")(C("rover"),C("cell_1_1"),C("cell_1_2"))
      now(21) = build("robot_at")(C("rover"),C("cell_1_2"))
      now(23) = build("robot_at")(C("rover"),C("cell_1_1"))
      now(24) = build("empty")(C("cell_1_1"))
      now(26) = build("empty")(C("cell_1_2"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2''))))",
      "P !((act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2''))))",
      "!((act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2''))))",
      "(act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2'')))",
      "act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))",
      "act_down(''rover'',''cell_1_1'',''cell_1_2'')",
      "@ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))",
      "robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2'')",
      "robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'')",
      "robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'')",
      "robot_at(''rover'',''cell_1-1'')",
      "down(''cell_1-1'',''cell_1-2'')",
      "empty(''cell_1-2'')",
      "!radiation(''cell_1-2'')",
      "radiation(''cell_1-2'')",
      "@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2''))",
      "@ (act_down(''rover'',''cell_1_1'',''cell_1_2''))",
      "act_down(''rover'',''cell_1_1'',''cell_1_2'')",
      "robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2'')",
      "robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'')",
      "robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'')",
      "robot_at(''rover'',''cell_1_2'')",
      "!robot_at(''rover'',''cell_1_1'')",
      "robot_at(''rover'',''cell_1_1'')",
      "empty(''cell_1_1'')",
      "!empty(''cell_1_2'')",
...
/*
  prop ltl_4 : !P !((act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2'')))) 
*/

class Formula_ltl_4(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_inspect_right")(C("rover"),C("cell_1_2"),C("cell_2_2"),C("tank2"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-2"))
      now(11) = build("tank_at")(C("tank2"),C("cell_2-2"))
      now(12) = build("right")(C("cell_1-2"),C("cell_2-2"))
      now(14) = build("inspected")(C("tank2"))
      now(17) = build("act_inspect_right")(C("rover"),C("cell_1_2"),C("cell_2_2"),C("tank2"))
      now(18) = build("inspected")(C("tank2"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2''))))",
      "P !((act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2''))))",
      "!((act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2''))))",
      "(act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2'')))",
      "act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'') -> @ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))",
      "act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')",
      "@ (robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2''))",
      "robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'') & !inspected(''tank2'')",
      "robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'') & right(''cell_1-2'',''cell_2-2'')",
      "robot_at(''rover'',''cell_1-2'') & tank_at(''tank2'',''cell_2-2'')",
      "robot_at(''rover'',''cell_1-2'')",
      "tank_at(''tank2'',''cell_2-2'')",
      "right(''cell_1-2'',''cell_2-2'')",
      "!inspected(''tank2'')",
      "inspected(''tank2'')",
      "@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')) -> (inspected(''tank2''))",
      "@ (act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2''))",
      "act_inspect_right(''rover'',''cell_1_2'',''cell_2_2'',''tank2'')",
      "inspected(''tank2'')"
  )
...
/*
  prop ltl_5 : !P !((act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1'')))) 
*/

class Formula_ltl_5(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_right")(C("rover"),C("cell_0_1"),C("cell_1_1"))
      now(10) = build("robot_at")(C("rover"),C("cell_0-1"))
      now(11) = build("right")(C("cell_0-1"),C("cell_1-1"))
      now(12) = build("empty")(C("cell_1-1"))
      now(14) = build("radiation")(C("cell_1-1"))
      now(17) = build("act_right")(C("rover"),C("cell_0_1"),C("cell_1_1"))
      now(21) = build("robot_at")(C("rover"),C("cell_1_1"))
      now(23) = build("robot_at")(C("rover"),C("cell_0_1"))
      now(24) = build("empty")(C("cell_0_1"))
      now(26) = build("empty")(C("cell_1_1"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1''))))",
      "P !((act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1''))))",
      "!((act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1''))))",
      "(act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))) & (@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1'')))",
      "act_right(''rover'',''cell_0_1'',''cell_1_1'') -> @ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))",
      "act_right(''rover'',''cell_0_1'',''cell_1_1'')",
      "@ (robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1''))",
      "robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'') & !radiation(''cell_1-1'')",
      "robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'') & empty(''cell_1-1'')",
      "robot_at(''rover'',''cell_0-1'') & right(''cell_0-1'',''cell_1-1'')",
      "robot_at(''rover'',''cell_0-1'')",
      "right(''cell_0-1'',''cell_1-1'')",
      "empty(''cell_1-1'')",
      "!radiation(''cell_1-1'')",
      "radiation(''cell_1-1'')",
      "@ (act_right(''rover'',''cell_0_1'',''cell_1_1'')) -> (robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1''))",
      "@ (act_right(''rover'',''cell_0_1'',''cell_1_1''))",
      "act_right(''rover'',''cell_0_1'',''cell_1_1'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'') & !empty(''cell_1_1'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'') & empty(''cell_0_1'')",
      "robot_at(''rover'',''cell_1_1'') & !robot_at(''rover'',''cell_0_1'')",
      "robot_at(''rover'',''cell_1_1'')",
      "!robot_at(''rover'',''cell_0_1'')",
      "robot_at(''rover'',''cell_0_1'')",
      "empty(''cell_0_1'')",
      "!empty(''cell_1_1'')",
      "empty(''cell_1_1'')"
...
/*
  prop ltl_6 : !P !((act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1'')))) 
*/

class Formula_ltl_6(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_inspect_right")(C("rover"),C("cell_1_1"),C("cell_2_1"),C("tank1"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-1"))
      now(11) = build("tank_at")(C("tank1"),C("cell_2-1"))
      now(12) = build("right")(C("cell_1-1"),C("cell_2-1"))
      now(14) = build("inspected")(C("tank1"))
      now(17) = build("act_inspect_right")(C("rover"),C("cell_1_1"),C("cell_2_1"),C("tank1"))
      now(18) = build("inspected")(C("tank1"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1''))))",
      "P !((act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1''))))",
      "!((act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1''))))",
      "(act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))) & (@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1'')))",
      "act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'') -> @ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))",
      "act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')",
      "@ (robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1''))",
      "robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'') & !inspected(''tank1'')",
      "robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'') & right(''cell_1-1'',''cell_2-1'')",
      "robot_at(''rover'',''cell_1-1'') & tank_at(''tank1'',''cell_2-1'')",
      "robot_at(''rover'',''cell_1-1'')",
      "tank_at(''tank1'',''cell_2-1'')",
      "right(''cell_1-1'',''cell_2-1'')",
      "!inspected(''tank1'')",
      "inspected(''tank1'')",
      "@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')) -> (inspected(''tank1''))",
      "@ (act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1''))",
      "act_inspect_right(''rover'',''cell_1_1'',''cell_2_1'',''tank1'')",
      "inspected(''tank1'')"
  )
...
/*
  prop ltl_7 : !P !((act_down(''rover'',''cell_1_1'',''cell_1_2'') -> @ (robot_at(''rover'',''cell_1-1'') & down(''cell_1-1'',''cell_1-2'') & empty(''cell_1-2'') & !radiation(''cell_1-2''))) & (@ (act_down(''rover'',''cell_1_1'',''cell_1_2'')) -> (robot_at(''rover'',''cell_1_2'') & !robot_at(''rover'',''cell_1_1'') & empty(''cell_1_1'') & !empty(''cell_1_2'')))) 
*/

class Formula_ltl_7(monitor: Monitor) extends Formula(monitor) {
...
/*
  prop ltl_8 : !P !((act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))) & (@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3'')))) 
*/

class Formula_ltl_8(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_down")(C("rover"),C("cell_1_2"),C("cell_1_3"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-2"))
      now(11) = build("down")(C("cell_1-2"),C("cell_1-3"))
      now(12) = build("empty")(C("cell_1-3"))
      now(14) = build("radiation")(C("cell_1-3"))
      now(17) = build("act_down")(C("rover"),C("cell_1_2"),C("cell_1_3"))
      now(21) = build("robot_at")(C("rover"),C("cell_1_3"))
      now(23) = build("robot_at")(C("rover"),C("cell_1_2"))
      now(24) = build("empty")(C("cell_1_2"))
      now(26) = build("empty")(C("cell_1_3"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
    // assignments5 (main formula excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))) & (@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3''))))",
      "P !((act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))) & (@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3''))))",
      "!((act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))) & (@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3''))))",
      "(act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))) & (@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3'')))",
      "act_down(''rover'',''cell_1_2'',''cell_1_3'') -> @ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))",
      "act_down(''rover'',''cell_1_2'',''cell_1_3'')",
      "@ (robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3''))",
      "robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'') & !radiation(''cell_1-3'')",
      "robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'') & empty(''cell_1-3'')",
      "robot_at(''rover'',''cell_1-2'') & down(''cell_1-2'',''cell_1-3'')",
      "robot_at(''rover'',''cell_1-2'')",
      "down(''cell_1-2'',''cell_1-3'')",
      "empty(''cell_1-3'')",
      "!radiation(''cell_1-3'')",
      "radiation(''cell_1-3'')",
      "@ (act_down(''rover'',''cell_1_2'',''cell_1_3'')) -> (robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3''))",
      "@ (act_down(''rover'',''cell_1_2'',''cell_1_3''))",
      "act_down(''rover'',''cell_1_2'',''cell_1_3'')",
      "robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'') & !empty(''cell_1_3'')",
      "robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'') & empty(''cell_1_2'')",
      "robot_at(''rover'',''cell_1_3'') & !robot_at(''rover'',''cell_1_2'')",
      "robot_at(''rover'',''cell_1_3'')",
      "!robot_at(''rover'',''cell_1_2'')",
      "robot_at(''rover'',''cell_1_2'')",
      "empty(''cell_1_2'')",
      "!empty(''cell_1_3'')",
...
/*
  prop ltl_9 : !P !((act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2'')))) 
*/

class Formula_ltl_9(monitor: Monitor) extends Formula(monitor) {
          
  override def evaluate(): Boolean = {
    // assignments1 (leaf nodes that are not rule calls):
      now(5) = build("act_inspect_right")(C("rover"),C("cell_1_3"),C("cell_2_3"),C("tank2"))
      now(10) = build("robot_at")(C("rover"),C("cell_1-3"))
      now(11) = build("tank_at")(C("tank2"),C("cell_2-3"))
      now(12) = build("right")(C("cell_1-3"),C("cell_2-3"))
      now(14) = build("inspected")(C("tank2"))
      now(17) = build("act_inspect_right")(C("rover"),C("cell_1_3"),C("cell_2_3"),C("tank2"))
      now(18) = build("inspected")(C("tank2"))
    // assignments2 (rule nodes excluding what is below @ and excluding leaf nodes):
    // assignments3 (rule calls):
    // assignments4 (the rest of rules that are below @ and excluding leaf nodes):
  ...
  txt = Array(
    "!P !((act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2''))))",
      "P !((act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2''))))",
      "!((act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2''))))",
      "(act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))) & (@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2'')))",
      "act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'') -> @ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))",
      "act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')",
      "@ (robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2''))",
      "robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'') & !inspected(''tank2'')",
      "robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'') & right(''cell_1-3'',''cell_2-3'')",
      "robot_at(''rover'',''cell_1-3'') & tank_at(''tank2'',''cell_2-3'')",
      "robot_at(''rover'',''cell_1-3'')",
      "tank_at(''tank2'',''cell_2-3'')",
      "right(''cell_1-3'',''cell_2-3'')",
      "!inspected(''tank2'')",
      "inspected(''tank2'')",
      "@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')) -> (inspected(''tank2''))",
      "@ (act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2''))",
      "act_inspect_right(''rover'',''cell_1_3'',''cell_2_3'',''tank2'')",
      "inspected(''tank2'')"
  )
...
class PropertyMonitor extends Monitor {
  def eventsInSpec: Set[String] = Set("radiation","robot_at","act_down","act_inspect_right","tank_at","act_right","right","empty","inspected","down")

  formulae ++= List(new Formula_ltl_0(this),new Formula_ltl_1(this),new Formula_ltl_2(this),new Formula_ltl_3(this),new Formula_ltl_4(this),new Formula_ltl_5(this),new Formula_ltl_6(this),new Formula_ltl_7(this),new Formula_ltl_8(this),new Formula_ltl_9(this))
}
